...
# ╔═╡ 002376fc-a967-4707-96fd-efb1a8405b2c
typeof(ten_twelve)
...
function print_as_matrix(M::FirstRankOneMatrix)
	...
	# Your code here
	return FirstRankOneMatrix(M.v,M.w)
end

# ╔═╡ 46bda3a4-5510-4050-b10e-ca0ae5bff1da
print_as_matrix(FirstRankOneMatrix([2,2,3], [3,4,5]))

# ╔═╡ c0c5a5a1-96b2-45e4-a58b-533b747602c7
FirstRankOneMatrix([2,2,3], [3,4,5])
...
R2 = RankOneMatrix([2,2,3], [3,4,5,6])
...
# ╔═╡ 5606d297-21f7-4b40-976d-541806005765
RankOneMatrix(1:3)

# ╔═╡ 0e7983ec-d7c5-40ee-be7e-a6ba56f2f74d
RankOneMatrix(1:3) + RankOneMatrix(1:3)
...
sum(RankTwoMatrix(1.0:1.0:10.0, 0.0:0.1:0.9))
...
function Base.getindex(M::RankTwoMatrix, i, j)
	...
	return (M.A + M.B)[i,j] # Your code here
end
...
struct LowRankMatrix <: AbstractMatrix{Float64}
	# Your code here
	Ms::Vector #Vector{RankOneMatrix}
	rank::Int
end
...
function Base.size(M::LowRankMatrix)
	...
	return length(M.Ms), length(M.Ms) # Your code here
end
...
# ╔═╡ bf33b1bc-98ea-422b-8b90-8cff3105dd9b
Base.size(RankOneMatrix([1,2], [3,4,5]))

# ╔═╡ f6ce76e5-b389-41a8-9c27-bcc28d37443c
RankOneMatrix(2:3)

# ╔═╡ abdccd69-07c3-4f2e-b790-461a71d01301
LowRankMatrix([RankOneMatrix([1,2])], 1)

# ╔═╡ 04374b02-ec5f-4d67-a071-94a54b662aad
LowRankMatrix([RankOneMatrix(1.0:1.0:10.0)], 4)
...
# ╔═╡ f92e7532-a197-485a-9e80-cc5ab261c50b
matvec(RankOneMatrix(1:3), [1,2,3])
