...
function demean(xs)
	...
	for i in xs
		count += 1
		new_array[count] = xs[count] - mean(xs)
	end
	return new_array
end
...
function create_bar()
	...
	for i in a
		count += 1
		if(count < max_count/2 - 10 || count > max_count/2 + 10)
			a[count] = 0
		end
	end
	return a
...
# ╔═╡ ee211fe4-9e24-4c92-b2fe-54a0fb7c38a0
...
# ╔═╡ 2cd30de7-e17e-48e4-bf33-5e048919a07e
function get_greens(image::AbstractMatrix)
	# your code here!
	return get_green.(image)
end

# ╔═╡ 873352f3-7e08-4d8b-b3f3-db2f8c5559a5
function get_blue(pixel::AbstractRGB)
	# your code here!
	return blue(pixel)
end

# ╔═╡ 8d5d9dd1-0fc1-48ac-a288-1a94d13c36d5
function get_blues(image::AbstractMatrix)
	# your code here!
	return get_blue.(image)
end

# ╔═╡ f9264872-9de3-41e4-9ec1-c910bc30f1ed
input = reshape([RGB(1.0, 1.0, 1.0), RGB(1.0, 1.0, 0.0)], (2,1))

# ╔═╡ 410faafc-a692-4d50-a251-035d17a41547
[RGB(1.0, 1.0, 1.0), RGB(1.0, 1.0, 0.0)]

# ╔═╡ 2bd89129-aba2-43d7-92e6-9281d895107f
RGB(1.0, 1.0, 0.5)

# ╔═╡ 59ffe1d7-54ec-4532-8310-4d50aa7c0b35
r = get_reds(philip)

# ╔═╡ 59f90cae-e206-44e2-b709-88e7f33a3c70
g = mean.(get_greens(philip))

# ╔═╡ 32b96470-4aa9-47a8-a0ce-86de9aa8b53c
b = mean.(get_blues(philip))

# ╔═╡ 58370897-ce0a-43c8-946e-953f560530e2
a = philip[1,1]

# ╔═╡ e12542ef-9644-4d5a-a8ba-a82aea13daf3
...
# ╔═╡ 4709779e-7e11-46cb-b495-7d1f6e930155
quantize(philip_head)

# ╔═╡ cc2ffa5d-373e-4355-a5bd-c936cda7b7f0
philip_head
